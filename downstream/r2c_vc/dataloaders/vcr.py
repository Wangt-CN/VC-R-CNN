...
from dataloaders._image_features_reader import ImageFeaturesH5Reader
...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        #### BU feature loader by WT ########
        self._image_features_reader = ImageFeaturesH5Reader('/gruntdata3/wangtan/vcr/vilbert/vilbert_beta/data/VCR/VCR_resnet101_faster_rcnn_genome.lmdb')
        self._gt_image_features_reader = ImageFeaturesH5Reader('/gruntdata3/wangtan/vcr/vilbert/vilbert_beta/data/VCR/VCR_gt_resnet101_faster_rcnn_genome.lmdb')

        self._max_region_num = 60
        self.path2id = json.load(open('/gruntdata3/wangtan/vcr/r2c/r2c/data/VCR_ImagePath2Id.json','r'))
        self.path2id_gt = json.load(open('/gruntdata3/wangtan/vcr/r2c/r2c/data/VCR_gt_ImagePath2Id.json','r'))
