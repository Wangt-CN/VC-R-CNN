    ...
    def __init__(
        ...
        if True:
            ...
            for img_id in self.ids:
                ...
                if has_valid_annotation(anno) and len(anno) > 3:
                    ids.append(img_id)
            self.ids = ids
        ...
        # use 10_100 bbox
        # self.box_dir = '/data4/tingjia/wt/budata/cocobu_box_test/'
        # self.bbox_10_100 = h5py.File('/data2/tingjia/wt/openimage/target_dir/coco/coco_train_all_10_100.hdf5', 'r')
